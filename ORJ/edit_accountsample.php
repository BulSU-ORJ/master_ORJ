...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            //function checker ng matches ng new pass and confirm pass
...
<body>
    <nav class="navbar nav-tabs navbar-expand-lg navbar-dark" style="background-color: #763435">
        ...
        <form class="form-container" enctype="multipart/form-data" method="POST" action="edit_accountsample.php" name="form_edit">
                <div class="form-group">
                <div id="checker"></div>
                <label for="fname">First Name:</label>
                    <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $member_firstname; ?>" autofocus>
                </div>
                <div class="form-group">
                ...
                <label for="lname">Last Name:</label>
                    <input type="text" class="form-control" id="lname" name="lname" value="<?php echo $member_lastname; ?>">
                </div>
