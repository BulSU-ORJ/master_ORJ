    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #763435">
      ...
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" >
            ...
            <li style="list-style-type:none;"><a class="btn nav-item" href="index.php" style="font-weight: bold" id="disabled">HOME</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-md-0 mb-4">
                <h6 style="color: black"><b>NAVIGATION</b></h6><br>
                    <div class="row">
                        <div class="col">
                            <a class="nav-link" href="index.php" style="font-weight: bold; padding-left:0px; color: white"><i class="fa fa-home"></i> HOME</a>
